...
server '13.233.186.183', port: 22, roles: [:web, :app, :db], primary: true
...
set :ssh_options, { forward_agent: true, user: fetch(:user), keys: %w(/Users/jay/Code\ Practice/rails_app_keys.pem) }
